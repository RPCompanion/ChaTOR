...
<script lang="ts">
    ...
    import { custom_emotes, delete_custom_emote } from "../../lib/network/custom_emote";
    ...
    <div class="flex flex-col gap-2">
        {#each $custom_emotes as emote}
            <div class="flex flex-row gap-2 px-2 relative">
                <input type="text" value={emote.emote_name} class="w-1/2 text-xl outline-none border-slate-500 border-2 rounded-md px-1"/>
                <input type="text" value={emote.emote} class="w-1/2 text-xl outline-none border-slate-500 border-2 rounded-md px-1"/>
