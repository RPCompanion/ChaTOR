...
<div>
    <ChatTabs/>
    <div bind:this={container} class="flex flex-col h-44 max-h-96 resize-y rounded-tr-md border-2 border-slate-700 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 chat-container-background">
