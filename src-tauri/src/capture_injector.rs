...
const SUPPORTED_SWTOR_CHECKSUM: [u8; 32] = [
    0x7B, 0x2E, 0x19, 0x1C, 0xB0, 0x3F, 0xB9, 0xC4, 0x0C, 0xDE, 0x75, 0x58, 0xD6, 0x42, 0x00, 0x60,
    0x07, 0x6A, 0xB2, 0x1A, 0x97, 0x55, 0x0C, 0x61, 0x79, 0xC1, 0x29, 0x25, 0x04, 0x1A, 0xD8, 0xEA
];
